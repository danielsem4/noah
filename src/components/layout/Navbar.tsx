          ...
          >
            ...
            <div className="flex items-center gap-3 px-6 pt-5 pb-4 border-b border-black/8">
              ...
              <div className="flex flex-col leading-tight text-right">
                <span className="text-black font-bold text-base" style={{ fontFamily: "'Frank Ruhl Libre', serif" }}>
                  קבוצת נח
                </span>
                <span className="text-black/50 text-xs font-medium">אירוח בע&quot;מ</span>
              </div>
            </div>
            ...
            <nav className="flex flex-col py-3 px-4" aria-label="ניווט נייד">
              {navLinks.map((link, i) => (
                <motion.button
                  ...
                  transition={{ delay: i * 0.07, ease: [0.25, 0.46, 0.45, 0.94] }}
                  onClick={() => goto(link.href)}
                  ...
                  onMouseEnter={e => {
                    ;(e.currentTarget as HTMLElement).style.background = 'rgba(173,101,46,0.08)'
